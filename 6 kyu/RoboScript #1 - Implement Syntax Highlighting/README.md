## Detail
[RoboScript #1 - Implement Syntax Highlighting](https://www.codewars.com/kata/roboscript-number-1-implement-syntax-highlighting/train/rust)
...
I just want to make it a project-look. Return `color: String` when matched is much concise.